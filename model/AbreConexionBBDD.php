<?php
    ...
    $hostdb = "localhost";
    $basededatos = "lastmonkey";    // sera el valor de nuestra BD
    $usuariodb = "monkey";    // sera el valor de nuestra BD
...
/*
    ...
    */
    $con = mysqli_connect($hostdb,$usuariodb, $clavedb, $basededatos) or die("No se puede conectar");
